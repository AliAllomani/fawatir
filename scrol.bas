...
Dim objForm As frmmain
   On Error GoTo errorHandler
    ...
    'If the flexGrid is the active control then
     If TypeOf frmmain.ActiveControl Is MSFlexGrid Then
        ' ##### Scroll direction #####
    ...
    Else
        ...
        WndProc = CallWindowProc(GetProp(frmmain.hwnd, "PrevWndProc"), hwnd, uMsg, wParam, lParam)
    End If
    Exit Function
errorHandler:
...
'
Public Function PtrToForm(ByVal lPtr As Long) As frmmain
Dim obj As frmmain
